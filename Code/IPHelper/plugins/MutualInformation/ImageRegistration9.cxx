...
int main( int argc, char *argv[] )
{
  ...
  FixedImageType::IndexValueType _insets[4] = { 0, 0, 0, 70 };
  start[0] = _insets[0];
  start[1] = _insets[2];
  ...
  optimizerScales[0] =  10000.010;
  optimizerScales[1] =  10.010;
  optimizerScales[2] =  10.010;
  optimizerScales[3] =  10000.010;
