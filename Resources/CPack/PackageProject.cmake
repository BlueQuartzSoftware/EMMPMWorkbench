...
SET(CPACK_PACKAGE_VERSION_MAJOR ${EIMApps_VER_MAJOR})
SET(CPACK_PACKAGE_VERSION_MINOR ${EIMApps_VER_MINOR})
SET(CPACK_PACKAGE_VERSION_PATCH ${EIMApps_VER_PATCH})
SET(CPACK_PACKAGE_VERSION ${EIMApps_VERSION})
...
IF (APPLE)
    set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${EIMApps_VERSION}-OSX")
elseif(WIN32)
    if ( CMAKE_SIZEOF_VOID_P EQUAL 8 )
        set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${EIMApps_VERSION}-Win64")
    else()
        set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${EIMApps_VERSION}-Win32")
    endif()
else()
  set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${EIMApps_VERSION}-${CMAKE_SYSTEM_NAME}")
endif()
...
SET(CPACK_SOURCE_PACKAGE_FILE_NAME "EM/MPM Gui-${EIMApps_VERSION}-Source")
