...
IF (APPLE)
  set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-TO79-OSX")
elseif(WIN32)
	if ( ${CMAKE_SIZEOF_VOID_P} EQUAL 8)
		set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-TO79-Win64")
	else()
		set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-TO79-Win32")
	endif()
else()
  set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-TO79-${CMAKE_SYSTEM_NAME}")
endif()
