...
elseif(WIN32)
    ...
    if ( "${CMAKE_SIZEOF_VOID_P}" EQUAL "8" )
            set(CPACK_PACKAGE_FILE_NAME "EmMpmWorkbench-${EmMpmWorkbench_VERSION_SHORT}-${EmMpmWorkbench_LINUX_SYSTEM}-x86_64")
            set (UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    elseif( "${CMAKE_SIZEOF_VOID_P}" EQUAL "4" )
            set(CPACK_PACKAGE_FILE_NAME "EmMpmWorkbench-${EmMpmWorkbench_VERSION_SHORT}-${EmMpmWorkbench_LINUX_SYSTEM}-i386")
            set (UPLOAD_FILE_NAME ${CPACK_PACKAGE_FILE_NAME}.tar.gz)
    else()
