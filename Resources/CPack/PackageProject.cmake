...
SET(CPACK_PACKAGE_VERSION_MAJOR ${QEMMPM_VER_MAJOR})
SET(CPACK_PACKAGE_VERSION_MINOR ${QEMMPM_VER_MINOR})
SET(CPACK_PACKAGE_VERSION_PATCH ${QEMMPM_VER_PATCH})
SET(CPACK_PACKAGE_VERSION ${QEMMPM_VERSION})
...
IF (APPLE)
    set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${QEMMPM_VERSION}-OSX")
elseif(WIN32)
    if ( CMAKE_SIZEOF_VOID_P EQUAL 8 )
        set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${QEMMPM_VERSION}-Win64")
    else()
        set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${QEMMPM_VERSION}-Win32")
    endif()
else()
  set(CPACK_PACKAGE_FILE_NAME "${PROJECT_NAME}-${QEMMPM_VERSION}-${CMAKE_SYSTEM_NAME}")
endif()
